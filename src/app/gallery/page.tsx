...
const galleryImages = {
  ...
  adventures: [
    ...
    { id: 2, src: 'https://uploads.onecompiler.io/42vvzq69s/42y6f786y/adventure-2.jpg', alt: 'River rafting in Bhutan' },
    { id: 3, src: 'https://uploads.onecompiler.io/42vvzq69s/42y6f786y/adventure-3.jpg', alt: 'Mountain biking in Bhutan' },
    { id: 4, src: '/images/gallery/adventures/adventure-4.jpg', alt: 'Trekking in Bhutan' },
    { id: 5, src: 'https://uploads.onecompiler.io/42vvzq69s/42y6f786y/adventure-5.jpg', alt: 'Adventure camping in Bhutan' },
    { id: 6, src: 'https://uploads.onecompiler.io/42vvzq69s/42y6f786y/adventure-6.png', alt: 'Hiking to remote monasteries' },
    { id: 7, src: 'https://uploads.onecompiler.io/42vvzq69s/42y6f786y/adventure-7.jpg', alt: 'Hot stone bath experience' },
  ],
};
